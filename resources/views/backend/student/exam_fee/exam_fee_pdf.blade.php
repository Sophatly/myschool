...
<body>
    ...
    @php
        ...
        $registrationfee = App\Models\FeeCategroyAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
	...
	<tr>
		<td>9</td>
		<td><b></b>Exam Fee for {{$exam_type}}</b></td>
		<td>{{$finalfee}} $</td>
	</tr>
